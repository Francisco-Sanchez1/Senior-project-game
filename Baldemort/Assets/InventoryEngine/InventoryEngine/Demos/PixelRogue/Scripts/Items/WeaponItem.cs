...
{	
	...
	public class WeaponItem : InventoryItem 
	{
		...
		{
			base.Equip(playerID);
			TargetInventory(playerID).TargetTransform.GetComponent<PlayerCntrl>().SetWeapon(WeaponSprite,this);
			return true;
		}
		...
		public override bool UnEquip(string playerID)
		{
			...
			TargetInventory(playerID).TargetTransform.GetComponent<PlayerCntrl>().SetWeapon(null,this);
			return true;
		}
